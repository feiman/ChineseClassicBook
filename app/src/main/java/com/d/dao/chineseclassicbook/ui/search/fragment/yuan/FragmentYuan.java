package com.d.dao.chineseclassicbook.ui.search.fragment.yuan;
...
public class FragmentYuan extends BaseNoInitRequestFragment<TangPresenter, TangModel, Tang, TangContent>
    ...
    protected void childLoad(String key, int page) {
        mPresenter.searchYuan(key, page);
    }
    ...
    protected void initRxListener() {
         ...
         * 监听在搜索新闻界面点击搜索
         */
        mRxManager.on(RxConstants.SEARCH_CLICK_YUAN, new Action1<String>() {
            @Override
