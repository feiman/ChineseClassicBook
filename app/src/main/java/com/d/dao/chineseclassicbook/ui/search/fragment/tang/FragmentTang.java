...
public class FragmentTang extends BaseNoInitRequestFragment<TangPresenter, TangModel, Tang, TangContent>
    ...
    protected void childLoad(String key, int page) {
        mPresenter.searchTang(key, page);
    }
    ...
    protected void initRxListener() {
         ...
         * 监听在搜索新闻界面点击搜索
         */
        mRxManager.on(RxConstants.SEARCH_CLICK_TANG, new Action1<String>() {
            @Override
